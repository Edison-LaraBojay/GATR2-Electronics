...
// holds getter functions that do work on retrieval. Runtime results are not
// here either: the resource stage polls each instance's executable and
// publishes into the ResourceMap.
//
